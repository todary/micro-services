...
class CreatePersonsTable extends Migration {
    ...
    public function up()
    {
        Schema::create('persons', function(Blueprint $table)
        {
            ...
            $table->integer('insert_date')->default(0);
            ...
            $table->boolean('is_premium_search')->default(0);
            $table->integer('department_id')->nullable();
            $table->integer('track_number')->default(0);
            $table->boolean('upgraded_to_premium')->default(0);
            $table->integer('search_credit_count')->default(1);
            $table->integer('search_analyst_status')->default(0);
            $table->float('on_complete_start_minute', 10, 0);
