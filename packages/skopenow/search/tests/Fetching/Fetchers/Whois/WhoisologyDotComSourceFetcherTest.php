...
class WhoisologyDotComSourceFetcherTest extends \TestCase
{
    public function testFetching()
    {
        ...
        setUrlMock("http://www.whois.com/whois/facebook.com", "");

        setUrlMock("https://whoisology.com/archive_12/facebook.com", file_get_contents(__DIR__ . '/../../../data/Whois/Whois-Whoisology-Domain-Facebook.html'));
    ...
    public function testFetchingEmptyData()
    {
        ...
        setUrlMock("https://whoisology.com/archive_12/facebook.com", file_get_contents(__DIR__ . '/../../../data/Whois/Whois-Whoisology-Domain-Facebook-EmptyData.html'));
    ...
    public function testPrivicyFetching()
    {
        ...
        setUrlMock("https://whoisology.com/archive_12/facebook.com", "zzzzz Registrant Privacy form ");
