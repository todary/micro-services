...
class WhoDotIsSourceFetcherTest extends \TestCase
{
    public function testFetching()
    {
        setUrlMock("http://api.whoxy.com/?key=e9ddbbd683d80d4xp03bcd61620bf20e&whois=facebook.com", "");

        setUrlMock("https://who.is/whois/facebook.com", file_get_contents(__DIR__ . '/../../../data/Whois/Whois-Whodotis-Domain-Facebook.html'));
    ...
    public function testFetchingEmptyData()
    {
        ...
        setUrlMock("https://who.is/whois/facebook.com", file_get_contents(__DIR__ . '/../../../data/Whois/Whois-Whodotis-Domain-Facebook-EmptyData.html'));
    ...
    public function testPrivicyFetching()
    {
        ...
        setUrlMock("https://who.is/whois/facebook.com", "asdsad Registrant Privacy form ");
