...
class LocationProcessor extends AbstractProcessor implements ProcessorInterface
{
    /**
     *
    ...
    public function process(array $state, array $data) :bool
    {
        ...
        $this->setDataModelAttribute("document", "location");
    ...
    protected function validateData(array $data)
    {
        ...
        if (empty($data["method"])) {
            $this->validation_notes['required'] = "method can't be empty" ;
        }

        if (empty($data["output"])) {
            $this->validation_notes['required'] = "output can't be empty" ;
        }
        return true;
    }
