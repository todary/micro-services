...
class AcceptanceProcessor extends AbstractProcessor implements ProcessorInterface
{
    /**
     *
    ...
    public function process(array $state, array $data) :bool
    {
        ...
        $this->setDataModelAttribute("document", "acceptance");
    ...
    {
        if (empty($data["url"])) {
            $this->validation_notes['required'] = "URL can't be empty" ;
        }
        return true;
    }
