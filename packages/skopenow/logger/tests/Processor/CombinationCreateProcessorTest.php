...
/** 
 * write test cases for the combination create processor class .
 * 
...
class CombinationCreateProcessorTest extends TestCase
{
	...
	public function testSuccessProcess()
	{
		...
		$requestProcess = new Skopenow\Logger\Processor\CombinationCreateProcessor(20);
