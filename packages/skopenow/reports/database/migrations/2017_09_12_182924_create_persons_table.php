...
class CreatePersonsTable extends Migration {
    ...
    public function up()
    {
        Schema::create('persons', function(Blueprint $table)
        {
            ...
            $table->text('usernames', 65535)->default('')->nullable();
            $table->text('added_usernames', 65535)->default('')->nullable();
            ...
            $table->integer('case_number')->default(0);
            ...
            $table->string('func', 50)->default('');
            $table->text('full_name', 65535)->default('');
            $table->string('searched_names', 500)->nullable()->index('searched_names');
            $table->text('added_emails', 65535)->default('');
