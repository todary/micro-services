...
class CreateResultTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('result', function (Blueprint $table) {
            ...
            $table->bigInteger('report_id')->unsigned()->index('fk_result_1_idx')->nullable();
            $table->integer('source_id')->index('fk_result_2_idx')->nullable();
            $table->string('source', 50)->nullable();
            $table->bigInteger('main_combination_id')->unsigned()->index('fk_result_3_idx')->nullable();
            $table->string('url', 700)->nullable();
            $table->string('type', 100)->nullable();
            $table->string('raw_type', 15)->nullable();
